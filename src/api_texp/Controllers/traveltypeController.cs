...
namespace api_texp.Controllers
{
    ...
    public class traveltypeController : Controller
    {
        ...
        {
            _context = context;
            _logger = loggerFactory.CreateLogger<traveltypeController>();
        }
        ...
        {
            var traveltypes= _context.traveltype.ToList<traveltype>();

            _logger.LogInformation(traveltypes.Count.ToString());
